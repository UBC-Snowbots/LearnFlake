...
if __name__ == "__main__":
    ...
    T = 500
    while True:
        # raw_sine = np.sin(step * 0.005)
        # command = raw_sine * 1
        # for act_id in gripper_jaw_ids:
        #     sim.data.ctrl[act_id] = command
        # sim.data.ctrl[gripper_z_id] = 0.0 
        # sine_val = np.sin(step * 0.005) * 1 # open and close with 0.8 threshold
        ...
        # custom open and close for rover's prismatic gripper
